        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                Temukan koleksi busana muslim terkini yang memadukan gaya modern dengan nilai-nilai islami. 
                Untuk wanita muslimah yang percaya diri dan berkarakter.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center space-x-1">
                  <span className="text-2xl font-bold text-rose-600">1000+</span>
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img
                src="https://images.pexels.com/photos/7691442/pexels-photo-7691442.jpeg?auto=compress&cs=tinysrgb&w=800"
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium">500+ Produk Tersedia</span>
                </div>
              </motion.div>
